...
const TechDonut = ({
  ...
  return (
    ...
    >
      ...
      <View
        className="absolute items-center justify-center bg-white/5 rounded-full"
        style={{
      ...
      >
        ...
        <Text
          className="text-white/70 text-[10px] font-bold uppercase tracking-widest mt-0.5"
          numberOfLines={1}
        >
          {label}
        </Text>
...
/**
 * AdminDashboardSection displays the primary overview metrics, 
 * recent activities, quick links, and priority focus items for the admin user.
 * 
 * @param {Object} props - Component props
 * @param {Function} props.setActiveTab - Function to change the active admin tab
 */
  ...
  const ACTIVITIES = [
    {
      ...
      bg: "bg-purple-100",
      details:
        "A new user registration for an Admin role was submitted by Andres Bonifacio. Awaiting approval from the super admin.",
    ...
    },
    {
      ...
      bg: "bg-emerald-100",
      details:
        "Batch approval of 14 student accounts from the pending queue. Welcome emails have been dispatched successfully.",
    ...
    },
    {
      ...
      bg: "bg-blue-100",
      details:
        "The scheduled synchronization of the Vector Database with the main curriculum storage completed successfully without errors.",
    ...
    },
    {
      ...
      bg: "bg-rose-100",
      details:
        "System auto-blocked an IP address after 5 consecutive failed login attempts on a teacher account.",
    ...
    },
    {
      ...
      bg: "bg-purple-100",
      details:
        "Batch approval of 15 student accounts from the pending queue. Welcome emails have been dispatched successfully.",
      actionLabel: "View Students",
    },
  ];
          ...
          <View className="flex-col sm:flex-row sm:items-center justify-between gap-6 z-10">
            <View className="flex-1">
              ...
              <Text className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl font-medium mb-6 sm:mb-0">
                Welcome to the administrator portal. Manage student and teacher
                accounts, monitor platform engagement, and oversee school-wide
                events from a centralized dashboard.
              </Text>
            </View>
            <Pressable
        ...
        <View className="flex-col xl:flex-row gap-6">
          ...
          <View className="flex-1">
            ...
            <Animated.View
              ...
              className="bg-white p-5 sm:p-6 rounded-3xl border border-slate-200 shadow-sm flex-col"
            >
              {/* Charts Row */}
              ...
              <View className="flex-1 w-full flex-col">
                <View className="flex-row justify-between items-center mb-4">
                  ...
                  <Pressable
                    onPress={() => setActiveTab("incident_response")}
                    className="bg-slate-50 px-3 py-1 rounded-lg border border-slate-200 active:bg-slate-100 transition-colors"
                  >
                    <Text className="text-slate-700 text-[10px] font-bold uppercase tracking-widest">
                      View All
                    </Text>
                  </Pressable>
                </View>
                  ...
                  {RECENT_INCIDENTS.slice(0, 3).map((incident) => {
                    ...
                    return (
                      <Pressable
                        key={incident.id}
                        onPress={() => setActiveTab("incident_response")}
                        className="p-3 rounded-xl border border-slate-100 bg-slate-50 hover:bg-white hover:border-slate-300 hover:shadow-md transition-all shadow-sm flex-row gap-3 items-center group"
                      >
                        <View
                          className={`w-8 h-8 rounded-lg items-center justify-center flex-shrink-0 border shadow-sm transition-transform group-hover:scale-105 ${styles.bg} ${styles.border}`}
                        >
                          <MaterialCommunityIcons
                        ...
                        <View className="flex-1">
                          <View className="flex-row justify-between items-center mb-1">
                            <Text
                              className={`font-black text-sm tracking-tight ${styles.text}`}
                            >
                              {incident.type}
                            </Text>
                          ...
                          <View className="flex-row justify-between items-center">
                            ...
                            <View
                              className={`px-2 py-0.5 rounded border ${styles.bg} ${styles.border}`}
                            >
                              <Text
          ...
          <View className="flex-1">
            ...
            <View className="flex-col gap-4">
              ...
              <Animated.View
                entering={FadeInDown.delay(400)}
                className="flex-1 bg-gradient-to-br from-purple-900 to-indigo-900 rounded-3xl p-4 sm:p-5 shadow-xl relative overflow-hidden group min-h-[160px]"
              >
                ...
                <View className="flex-row justify-between items-start z-10 h-full">
                  <View className="flex-1 flex-col justify-between h-full">
                    <View className="flex-row items-center justify-between mb-2">
                      ...
                      <View className="bg-purple-500/40 px-3 py-1.5 rounded-full border border-purple-400/50 self-start md:hidden lg:flex">
                        <Text className="text-purple-100 text-[10px] font-bold uppercase tracking-widest">
                          Active
                        </Text>
                      </View>
                    </View>
                    <View className="z-10 mt-auto">
                      <Text className="text-purple-200 text-xs font-bold uppercase tracking-widest mb-1">
                        Blockchain Network
                      </Text>
                      <Text className="text-lg sm:text-xl font-black text-white tracking-tight mb-1">
                        {currentWeb3.title}
                      </Text>
                  ...
                  <View className="items-center justify-center z-10 self-center pl-2 sm:pl-4">
                    <TechDonut
                      ...
                      onPress={() =>
                        setWeb3MetricIdx(
                          (web3MetricIdx + 1) % web3Metrics.length,
                        )
                      }
                    />
                  </View>
              ...
              <Animated.View
                ...
                className="flex-1 bg-gradient-to-br from-blue-900 to-sky-900 rounded-3xl p-4 sm:p-5 shadow-xl relative overflow-hidden group min-h-[160px]"
              >
                ...
                <View className="flex-row justify-between items-start z-10 h-full">
                  ...
                  <View className="items-center justify-center z-10 self-center pl-2 sm:pl-4">
                    <TechDonut
                      ...
                      onPress={() =>
                        setEdgeMetricIdx(
                          (edgeMetricIdx + 1) % edgeMetrics.length,
                        )
                      }
                    />
                  </View>
              ...
              <Animated.View
                ...
                className="flex-1 bg-gradient-to-br from-emerald-900 to-teal-900 rounded-3xl p-4 sm:p-5 shadow-xl relative overflow-hidden group min-h-[160px]"
              >
                ...
                <View className="flex-row justify-between items-start z-10 h-full">
                  <View className="flex-1 flex-col justify-between h-full">
                    <View className="flex-row items-center justify-between mb-2">
                      ...
                      <View className="bg-emerald-500/40 px-3 py-1.5 rounded-full border border-emerald-400/50 self-start md:hidden lg:flex">
                        <Text className="text-emerald-100 text-[10px] font-bold uppercase tracking-widest">
                          Active
                        </Text>
                      </View>
                    </View>
                    <View className="z-10 mt-auto">
                      <Text className="text-emerald-200 text-xs font-bold uppercase tracking-widest mb-1">
                        AI Services
                      </Text>
                      <Text className="text-lg sm:text-xl font-black text-white tracking-tight mb-1">
                        {currentAi.title}
                  ...
                  <View className="items-center justify-center z-10 self-center pl-2 sm:pl-4">
                    <TechDonut
                      ...
                      trackColor="#064e3b"
                      onPress={() =>
                        setAiMetricIdx((aiMetricIdx + 1) % aiMetrics.length)
                      }
                    />
                  </View>
                </View>
            ...
            <View className="flex-row gap-3">
              ...
              <Pressable
                onPress={() => {
                  ...
                  alert(`${selectedActivity.actionLabel} action triggered.`);
                }}
                className={`flex-1 py-3 rounded-lg items-center shadow-md transition-transform active:scale-95 ${selectedActivity.type === "Security" ? "bg-rose-600 active:bg-rose-700 shadow-rose-500/30" : "bg-slate-900 active:bg-slate-800 shadow-slate-900/20"}`}
              >
