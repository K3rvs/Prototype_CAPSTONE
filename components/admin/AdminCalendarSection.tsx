          ...
          <View className="flex-row items-center gap-4 relative z-10">
            ...
            <View>
              ...
              <Text className="text-slate-500 text-sm font-medium mt-0.5">
                Manage domain-wide events and mandates
              </Text>
            </View>
          </View>
        </View>
                  ...
                  <View className="flex-row flex-wrap flex-1">
                    {Array.from({ length: 35 }).map((_, i) => {
                      ...
                      return (
                        <Pressable
                          ...
                          onPress={() => {
                            if (isValidDate && dayEvents.length > 0) {
                              ...
                              const eventToOpen = ACADEMIC_CALENDAR.find((e) =>
                        ...
                        >
                          <View
                            className={`w-full h-full rounded-xl p-2 transition-all ${!isValidDate ? "bg-transparent" : isToday ? "bg-sky-500 shadow-md shadow-sky-500/30" : "bg-slate-50 hover:bg-sky-50 active:bg-sky-100 border border-slate-100/50"}`}
                          >
                            {isValidDate && (
                              <>
                                <View className="flex-row justify-between items-start mb-1">
                                  <Text
                                    className={`text-xs sm:text-sm font-bold ${isToday ? "text-white" : "text-slate-700 group-hover:text-sky-900"}`}
                                  >
                                    {date}
                                  </Text>
                                </View>
                  ...
                  <View className="flex-row items-center justify-between mb-4 pb-4 border-b border-slate-100 z-10 relative">
                    ...
                    <View className="bg-sky-50 px-3 py-1 rounded-full border border-sky-100">
                      <Text className="text-sky-800 text-[10px] font-black uppercase tracking-widest">
                        {ACADEMIC_CALENDAR.length} Items
                      </Text>
                    </View>
                  </View>
                    ...
                    <View className="flex-row flex-wrap gap-2">
                      {[
                        ...
                        <Pressable
                          ...
                          className={`px-4 py-2.5 rounded-xl border flex-row items-center gap-2 shadow-sm transition-colors ${newEventScope === scope ? "bg-sky-50 border-sky-200" : "bg-white border-slate-200"}`}
                        >
                          <MaterialCommunityIcons
                            name={
                              newEventScope === scope
                            ...
                            size={16}
                            color={
                              newEventScope === scope ? "#0284c7" : "#94a3b8"
                            }
                          />
                          <Text
                            className={`font-bold text-sm ${newEventScope === scope ? "text-sky-700" : "text-slate-600"}`}
                          >
                            {scope}
                          </Text>
                        </Pressable>
