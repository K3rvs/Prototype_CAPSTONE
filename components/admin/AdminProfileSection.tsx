          ...
          <View className="flex-col sm:flex-row justify-between sm:items-center mb-4 gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm z-10">
            <View className="flex-row items-center gap-4 flex-1">
              ...
              <View className="flex-1">
                <Text className="text-2xl font-black text-slate-900 tracking-tight">Admin Profile</Text>
            ...
            <Animated.View entering={FadeInDown.delay(100)} className="w-full lg:w-1/3 flex-col gap-4">
              <View className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm items-center">
                <View className="w-24 h-24 bg-purple-100 rounded-full items-center justify-center border-4 border-purple-50 shadow-sm mb-3 relative">
                  <Text className="text-3xl font-black text-purple-700">AM</Text>
                ...
                <Text className="text-xl font-black text-slate-900 mb-1">Admin User</Text>
                <Text className="text-slate-500 font-medium text-sm mb-3">admin@deped.gov.ph</Text>
                
                <View className="bg-purple-50 px-3 py-1.5 rounded-full border border-purple-200">
                  <Text className="text-purple-800 text-[10px] font-black uppercase tracking-widest">Super Administrator</Text>
                </View>
              </View>
              ...
              <View className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm gap-3">
                ...
                <View className="flex-row items-center justify-between py-2 border-b border-slate-100">
                  ...
                  <Text className="text-slate-800 font-bold text-sm">2 Devices</Text>
                </View>
                <View className="flex-row items-center justify-between py-2">
                  <Text className="text-slate-500 font-medium text-sm">Password Changed</Text>
                  <Text className="text-slate-800 font-bold text-sm">3 months ago</Text>
                </View>
              </View>
            ...
            <Animated.View entering={FadeInDown.delay(200)} className="w-full lg:w-2/3 flex-col gap-4">
                ...
                <View className="gap-4 mb-6">
                  <View className="flex-col sm:flex-row gap-4">
                    <View className="flex-1">
                      ...
                      <TextInput defaultValue="Admin" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-purple-500 focus:bg-white transition-colors shadow-sm" />
                    </View>
                    <View className="flex-1">
                      <Text className="text-slate-700 font-bold mb-2 text-sm">Last Name</Text>
                      <TextInput defaultValue="User" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-purple-500 focus:bg-white transition-colors shadow-sm" />
                    </View>
                  </View>
                  <View>
                    <Text className="text-slate-700 font-bold mb-2 text-sm">Email Address</Text>
                    <TextInput defaultValue="admin@deped.gov.ph" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-purple-500 focus:bg-white transition-colors shadow-sm" />
                  </View>
                  <View>
                    <Text className="text-slate-700 font-bold mb-2 text-sm">Phone Number</Text>
                    <TextInput defaultValue="+63 912 345 6789" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-purple-500 focus:bg-white transition-colors shadow-sm" />
                  </View>
                </View>
              ...
              <View className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm">
                ...
                <View className="flex-col sm:flex-row justify-between items-start sm:items-center py-3 border-b border-slate-100 gap-3">
                  ...
                  <View className="w-12 h-6 bg-purple-600 rounded-full p-0.5 cursor-pointer shadow-inner">
                    <View className="w-5 h-5 bg-white rounded-full shadow-sm translate-x-6" />
                  </View>
                </View>
                ...
                <View className="flex-col sm:flex-row justify-between items-start sm:items-center py-3 border-b border-slate-100 gap-3">
                  <View>
                    ...
                    <Text className="text-slate-500 text-xs mt-0.5">Last changed 3 months ago.</Text>
                  </View>
