...
export const StudentDashboardSection = ({ onNavigate }: any) => {
  ...
  const [communityActivityModalOpen, setCommunityActivityModalOpen] =
    useState(false);
  ...
  const DETAILED_STANDINGS = [
    ...
    },
    {
      ...
      assessments: [
        {
          title: "Module 1: Philippine Lit",
          score: "7/10",
          status: "Completed",
        },
        {
          title: "Module 2: Genre Readings",
          score: "8/10",
          status: "Completed",
        },
        {
          title: "Module 3: Poetry Analysis",
          score: "10/10",
          status: "Completed",
        },
        {
  ...
  const BADGES = [
    {
      id: "b1",
      title: "First to Suffer",
      icon: "🏃",
      color: "amber",
      hash: "0x4a9d...a7b2",
      desc: "Awarded for being the first student to submit all assignments on time in Term 1.",
      date: new Date(today.getTime() - 86400000 * 2).toLocaleDateString(),
    },
    {
      id: "b2",
      title: "Laging Handa",
      ...
      color: "emerald",
      hash: "0xb2e1...f8c9",
      desc: "Awarded for perfect attendance and punctuality for consecutive weeks.",
      date: new Date(today.getTime() - 86400000 * 5).toLocaleDateString(),
    },
    {
      id: "b3",
      title: "Math Wizard",
      ...
      color: "sky",
      hash: "0xc3f2...d1e4",
      desc: "Achieved the highest score in the midterm Mathematics examination.",
      date: new Date(today.getTime() - 86400000 * 12).toLocaleDateString(),
    },
    {
      id: "b4",
      title: "Science Geek",
      ...
      color: "purple",
      hash: "0xd4a3...e2f5",
      desc: "Successfully completed the Science Fair project with distinction.",
      date: new Date(today.getTime() - 86400000 * 18).toLocaleDateString(),
    },
    {
      id: "b5",
      title: "Bookworm",
      ...
      color: "rose",
      hash: "0xe5b4...f3a6",
      desc: "Read and reviewed 10 books in the first semester.",
      date: new Date(today.getTime() - 86400000 * 25).toLocaleDateString(),
    },
    {
      id: "b6",
      title: "Tech Savvy",
      ...
      color: "blue",
      hash: "0x1a2b...3c4d",
      desc: "Mastered basic programming fundamentals and created a utility app.",
      date: new Date(today.getTime() - 86400000 * 30).toLocaleDateString(),
    },
    {
      id: "b7",
      title: "Team Player",
      ...
      color: "teal",
      hash: "0x5e6f...7g8h",
      desc: "Demonstrated exceptional collaboration skills in group projects.",
      date: new Date(today.getTime() - 86400000 * 42).toLocaleDateString(),
    },
    {
      id: "b8",
      title: "Creative Mind",
      ...
      color: "pink",
      hash: "0x9i0j...1k2l",
      desc: "Submitted the most creative multimedia presentation.",
      date: new Date(today.getTime() - 86400000 * 50).toLocaleDateString(),
    },
    {
      id: "b9",
      ...
      color: "orange",
      hash: "0x3m4n...5o6p",
      desc: "Delivered an outstanding speech during the school assembly.",
      date: new Date(today.getTime() - 86400000 * 65).toLocaleDateString(),
    },
    {
      id: "b10",
      ...
      color: "indigo",
      hash: "0x7q8r...9s0t",
      desc: "Successfully solved the most complex logical puzzles in class.",
      date: new Date(today.getTime() - 86400000 * 80).toLocaleDateString(),
    },
  ];
  ...
  const METRICS = [
    {
      ...
      icon: "chart-line",
      percent: 88,
      gradFrom: "from-purple-900",
      gradTo: "to-indigo-900",
      donutColor: "#c084fc",
      trackColor: "#4c1d95",
      iconColor: "#e9d5ff",
      titleColor: "text-purple-200",
      pillBg: "bg-purple-500/40",
    ...
    },
    {
      ...
      value: "3 Active",
      trend: "2 New Mentions",
      trendUp: true,
      icon: "account-group",
      percent: 100,
      gradFrom: "from-amber-900",
      gradTo: "to-orange-900",
      donutColor: "#fbbf24",
      trackColor: "#78350f",
      iconColor: "#fde68a",
      titleColor: "text-amber-200",
      pillBg: "bg-amber-500/40",
  ...
  const PRIORITY_TASKS = [
    {
      ...
      color: "text-rose-600",
      bg: "bg-rose-100",
      details: "Submit your solutions for General Mathematics Module 2.",
      route: "classes",
    },
    {
      id: "p2",
      title: "Science Innovators Club",
      text: "2 new mentions in the group chat.",
      type: "Communities",
      action: "View Chat",
      time: "New",
      ...
      color: "text-sky-600",
      bg: "bg-sky-100",
      details: "Sam and Alex tagged you regarding the study guide.",
      route: "communities",
    },
    {
      id: "p3",
      title: "The Librarian",
      text: "You are 2 modules away from this SBT.",
      type: "Passport",
      action: "Read Modules",
      time: "In Progress",
      ...
      bg: "bg-purple-100",
      details:
        "Download and read the remaining modules in 21st Century Lit to unlock this badge.",
      route: "passport",
    },
    {
      id: "p4",
      title: "Literature Output",
      text: "Due in 3 days (June 25).",
      type: "Calendar",
      action: "View Details",
      time: "Upcoming",
      icon: "calendar-star",
      ...
      bg: "bg-amber-100",
      details: "Submit your poetry analysis draft for 21st Century Lit.",
      route: "calendar",
    },
  ];
  ...
  const UPCOMING_DEADLINES = [
    {
      id: "d1",
      title: "Math Problem Set 4",
      class: "General Mathematics",
      date: "Today",
    },
    {
      id: "d2",
      title: "Literature Output",
      class: "21st Century Lit",
      date: new Date(today.getTime() + 86400000 * 3).toLocaleDateString(
        "en-US",
    ...
    {
      id: "d3",
      title: "Citations Assessment",
      class: "Practical Research 2",
    ...
    return (
      <View className="flex-1 bg-slate-50">
        ...
        >
          {/* Hero Card */}
          <Animated.View
            className="w-full rounded-3xl p-6 shadow-lg relative overflow-hidden border border-sky-100"
          ...
          >
            ...
            <Text className="text-slate-600 text-sm mb-5 leading-relaxed font-medium">
              You have 3 upcoming deadlines and 2 new SBTs awarded. Let&apos;s
              make today productive.
            </Text>
            <Pressable
              onPress={() => onNavigate("classes")}
              className="bg-sky-600 active:bg-sky-700 py-3.5 rounded-xl flex-row items-center justify-center gap-2 shadow-md"
            >
              <MaterialCommunityIcons
                name="play-circle"
                size={18}
                  ...
                  >
                    ...
                    >
                      ...
                      <View className="w-full mt-2">
                        <Text
                          className={`${metric.titleColor} text-[9px] font-bold uppercase tracking-widest mb-0.5`}
                          numberOfLines={1}
                        >
                          {metric.title}
                        </Text>
                        ...
                        <View className="flex-row items-center gap-1">
                          ...
                          />
                          <Text
                            className={`${metric.titleColor} text-[9px] font-medium`}
                            numberOfLines={1}
                          >
                            {metric.trend}
                          </Text>
              ...
              {FAST_ACTIONS.map((action, i) => (
                <Animated.View key={action.id} className="w-[48%]">
                  ...
                  >
                    ...
                    <View className="flex-row justify-between items-start w-full">
                      <View
                        className={`w-12 h-12 rounded-2xl items-center justify-center border-2 border-white shadow-sm ${action.iconBg}`}
                      >
                        <MaterialCommunityIcons
                          name={action.icon as any}
                          size={24}
                    ...
                    <View className="w-full mt-3">
                      <Text className="text-slate-800 font-bold text-sm tracking-tight mb-0.5">
                        {action.label}
                      </Text>
          ...
          <View className="mb-6 gap-3">
            ...
            <Animated.View className="bg-white rounded-3xl p-4 sm:p-5 border border-slate-200 shadow-xl overflow-hidden w-full">
                      ...
                      <View className="flex-1 justify-center">
                        <View className="flex-row items-center gap-2 mb-1">
                          ...
                          <View className={`px-2 py-0.5 rounded-md ${task.bg}`}>
                            <Text
                              className={`text-[9px] font-bold uppercase tracking-widest ${task.color}`}
                            >
                              {task.time}
                            </Text>
                          </View>
          ...
          <Animated.View className="bg-white rounded-3xl p-6 flex-col border border-slate-200 relative overflow-hidden min-h-[260px] mb-6">
            <MaterialCommunityIcons
              name="shield-check"
              size={140}
              color="#f3e8ff"
            ...
            <View className="flex-row items-center justify-between mb-6 z-10 w-full gap-4">
              ...
              <View className="flex-row items-center gap-2">
                <Pressable
                  ...
                  className="bg-purple-50 hover:bg-purple-100 px-4 py-2.5 rounded-xl border border-purple-200 flex-row items-center justify-center min-w-[70px]"
                >
                  <Text className="text-purple-600 font-bold text-xs tracking-widest uppercase text-center">
                    More
                  </Text>
                </Pressable>
                <View className="flex-row items-center gap-1.5 ml-1">
                  <Pressable
                    onPress={() =>
                      passportScrollRefMobile.current?.scrollTo({
                        x: Math.max(0, passportScrollXMobile.current - 140),
                        animated: true,
                      })
                    }
                  ...
                  <Pressable
                    onPress={() =>
                      passportScrollRefMobile.current?.scrollTo({
                        x: passportScrollXMobile.current + 140,
                        animated: true,
                      })
                    }
                    className="bg-slate-50 w-10 h-10 rounded-xl items-center justify-center border border-slate-200 active:bg-slate-100"
            ...
            <ScrollView
              ...
              onScroll={(e) => {
                passportScrollXMobile.current = e.nativeEvent.contentOffset.x;
              }}
            ...
            >
              {BADGES.map((badge, idx) => (
                <Pressable
                  ...
                  className="bg-white p-4 rounded-3xl border border-slate-200 w-32 h-32 items-center justify-center flex-col gap-3 active:scale-95 transition-transform cursor-pointer"
                >
                  <View
                    className={`w-14 h-14 bg-${badge.color}-50 rounded-2xl items-center justify-center border border-${badge.color}-100`}
                  >
                    <Text className="text-3xl">{badge.icon}</Text>
                  </View>
                  <Text
                    className="text-slate-800 font-black text-xs text-center tracking-tight"
                    numberOfLines={1}
                  >
                    {badge.title}
                  </Text>
        ...
        >
          {selectedBadge && (
            <View className="py-2 items-center">
              <View
                className={`w-24 h-24 rounded-3xl bg-${selectedBadge.color}-100 items-center justify-center border-4 border-white shadow-md mb-4`}
              >
              ...
              <View className="flex-row items-center gap-1.5 bg-slate-100 px-3 py-1.5 rounded-full border border-slate-200 mb-6">
                <MaterialCommunityIcons
                  ...
                  color="#64748b"
                />
                <Text className="text-slate-500 font-mono text-xs tracking-widest">
                  {selectedBadge.hash}
                </Text>
              </View>
              ...
              <TouchableOpacity
                ...
                className="w-full bg-slate-900 py-4 rounded-xl items-center transition-colors shadow-md"
              >
        ...
        >
          {deadlineModal && (
            <View className="items-center py-4">
              ...
              <Text className="text-xl font-black text-slate-800 text-center mb-1">
                {deadlineModal.title}
              </Text>
              <Text className="text-slate-500 font-bold text-xs uppercase mb-6">
                {deadlineModal.class}
              </Text>
              <View className="flex-row gap-3 w-full">
                <TouchableOpacity
                  activeOpacity={0.7}
                  onPress={() => setDeadlineModal(null)}
                ...
                <TouchableOpacity
                  ...
                  className="flex-[2] bg-rose-600 py-3.5 rounded-xl items-center"
                >
        ...
        >
          <View className="py-2 w-full">
            ...
            <View className="bg-purple-900/10 border border-purple-200/50 p-4 rounded-2xl mb-4 flex-row items-center justify-between">
              <View>
                <Text className="text-purple-900 font-black text-xl">
                  Overall Average: 88%
                </Text>
                <Text className="text-purple-700 text-xs font-semibold mt-0.5">
                  Top 20% of Class • 9/12 Completed
                </Text>
              </View>
              <TechDonut
                size={55}
            ...
            <ScrollView
              className="max-h-[50vh] mb-4 pr-1"
            ...
            >
              <View className="gap-4">
                {DETAILED_STANDINGS.map((sub, index) => (
                  <View
                    key={sub.id}
                    className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex-col"
                  >
                    {/* Subject Title & Average */}
                    <View className="flex-row justify-between items-start mb-2 border-b border-slate-100 pb-2">
                      <View className="flex-1 pr-2">
                        <Text className="text-slate-900 font-black text-base leading-tight">
                          {sub.name}
                        </Text>
                        <Text className="text-slate-500 text-xs font-medium mt-0.5">
                          {sub.teacher} • {sub.completedCount}
                        </Text>
                      </View>
                      <View className="items-end">
                        <Text
                          className={`text-${sub.color}-600 font-black text-lg`}
                        >
                          {sub.average}
                        </Text>
                      ...
                      {sub.assessments.map((ass, aIdx) => (
                        ...
                        >
                          <View className="flex-row items-center gap-1.5 flex-1 pr-2">
                            ...
                            />
                            <Text
                              className="text-slate-600 text-xs font-medium flex-1"
                              numberOfLines={1}
                            >
                              {ass.title}
                            </Text>
                          ...
                          <Text
                            className={`text-xs font-mono font-black ${ass.status === "Completed" ? "text-slate-800" : "text-amber-600"}`}
                          >
                            {ass.score}
                          </Text>
                        </View>
                    ...
                    >
                      <MaterialCommunityIcons
                        ...
                        size={14}
                        className={`text-${sub.color}-700`}
                      />
                      <Text
                        className={`text-${sub.color}-700 font-bold text-xs`}
                      >
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => setStandingModalOpen(false)}
              className="w-full bg-slate-900 py-4 rounded-xl items-center transition-colors shadow-md"
            >
              <Text className="text-white font-bold text-sm tracking-widest uppercase">
                Close
        ...
        <GlobalModal
          isOpen={sbtSummaryModalOpen}
          onClose={() => setSbtSummaryModalOpen(false)}
          title="SBT Summary"
        >
          <View className="py-2 w-full">
            <Text className="text-slate-500 font-bold text-xs uppercase tracking-widest mb-4">
              Soulbound Tokens Achievement
            </Text>
            <View className="bg-purple-50 border border-purple-100 p-4 rounded-2xl mb-4 flex-row items-center justify-between">
              <View>
                ...
                <Text className="text-purple-600 text-xs font-semibold mt-0.5">
                  23% Overall Progress
                </Text>
              </View>
            ...
            <View className="bg-slate-50 border border-slate-200 p-4 rounded-2xl shadow-inner w-full mb-6 gap-3">
              ...
              <View className="flex-row items-center gap-3 pb-1">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-slate-500 text-[10px]">
                    Time Agent Category • 5 days ago
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="flex-row gap-3 w-full">
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => setSbtSummaryModalOpen(false)}
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => {
                  setSbtSummaryModalOpen(false);
                  onNavigate("passport");
                }}
                className="flex-[2] bg-purple-600 py-3.5 rounded-xl items-center"
              >
                <Text className="text-white font-bold text-sm">
                  View Passport
                </Text>
        ...
        <GlobalModal
          isOpen={studyProgressModalOpen}
          onClose={() => setStudyProgressModalOpen(false)}
          title="Study Progress"
        >
          <View className="py-2 w-full">
            <Text className="text-slate-500 font-bold text-xs uppercase tracking-widest mb-4">
            ...
            <View className="flex-row gap-3 w-full">
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => setStudyProgressModalOpen(false)}
                className="flex-1 bg-slate-100 py-3.5 rounded-xl items-center border border-slate-200"
              >
                <Text className="text-slate-700 font-bold text-sm">Close</Text>
              </TouchableOpacity>
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => {
                  setStudyProgressModalOpen(false);
                  onNavigate("classes");
                }}
                className="flex-[2] bg-emerald-600 py-3.5 rounded-xl items-center"
              >
                <Text className="text-white font-bold text-sm">
                  Open Classes
                </Text>
        ...
        <GlobalModal
          isOpen={communityActivityModalOpen}
          onClose={() => setCommunityActivityModalOpen(false)}
          title="Community Activity"
        >
          <View className="py-2 w-full">
            <Text className="text-slate-500 font-bold text-xs uppercase tracking-widest mb-4">
              Group Hub Engagement
            </Text>
            <View className="bg-amber-50 border border-amber-100 p-4 rounded-2xl mb-4 flex-row items-center justify-between">
              <View>
                <Text className="text-amber-900 font-black text-xl">
                  3 Joined Clubs
                </Text>
            ...
            <View className="flex-row gap-3 w-full">
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => setCommunityActivityModalOpen(false)}
                className="flex-1 bg-slate-100 py-3.5 rounded-xl items-center border border-slate-200"
              >
                <Text className="text-slate-700 font-bold text-sm">Close</Text>
              </TouchableOpacity>
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => {
                  setCommunityActivityModalOpen(false);
                  onNavigate("communities");
                }}
                className="flex-[2] bg-amber-600 py-3.5 rounded-xl items-center"
              >
                <Text className="text-white font-bold text-sm">
                  Open Communities
                </Text>
  ...
  return (
    ...
    >
      <ScrollView
        ...
        contentContainerClassName="p-4 sm:p-6 pb-16 gap-6 sm:gap-8"
      >
        {/* 1. HERO WIDGET */}
        <Animated.View className="w-full bg-gradient-to-br from-sky-50 via-white to-sky-100 rounded-3xl p-6 sm:p-8 shadow-2xl overflow-hidden relative border border-sky-200">
          {Platform.OS === "web" && (
            <>
            ...
            {METRICS.map((metric, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {Platform.OS === "web" && (
                      <View className="absolute -right-10 -bottom-10 w-40 h-40 bg-white/10 rounded-full pointer-events-none" />
                    )}
                    <MaterialCommunityIcons
                      name={metric.icon as any}
                      size={100}
                      color="#ffffff"
                      className="absolute -left-4 -bottom-4 opacity-10 pointer-events-none"
                    />
                    ...
                    <View className="flex-row justify-between items-center z-10 h-full w-full gap-4">
                      <View className="flex-1 flex-col justify-between h-full pr-2">
                        ...
                        <View>
                          <Text
                            className={`${metric.titleColor} text-xs font-bold uppercase tracking-widest mb-1`}
                          >
                            {metric.title}
                          </Text>
                          <Text className="text-3xl sm:text-4xl font-black text-white mb-1 tracking-tight">
                            {metric.value}
                          </Text>
                          <View className="flex-row items-center gap-1.5 mt-1">
                            ...
                            />
                            <Text
                              className={`${metric.titleColor} text-xs font-medium`}
                            >
                              {metric.trend}
                            </Text>
                          </View>
        ...
        <View className="flex-col lg:flex-row gap-4 sm:gap-6 mb-6 px-2 w-full">
            ...
            <View className="flex-row flex-wrap gap-3">
              {FAST_ACTIONS.map((action, i) => (
                <Animated.View
                  ...
                  style={
                    Platform.OS !== "web"
                      ? { width: "48%", marginBottom: 8, aspectRatio: 1 }
                      : {}
                  }
                >
                  <Pressable
                  ...
                  >
                    {Platform.OS === "web" && (
                      <View
                        className={`absolute -right-6 -bottom-6 w-32 h-32 rounded-full  opacity-10 transition-transform duration-500 group-hover:scale-150 group-hover:opacity-20 ${action.blob}`}
                      />
                    )}
                    <MaterialCommunityIcons
                      name={action.icon as any}
                    ...
                    <View className="w-full z-10 mt-3">
                      <Text className="text-slate-800 font-black text-sm sm:text-lg tracking-tight group-hover:text-slate-900 transition-colors mb-0.5">
                        {action.label}
                      </Text>
          ...
          <View className="flex-1 flex-col w-full h-full">
            ...
            <View className="flex-1 w-full flex-col lg:relative">
              <Animated.View className="bg-white/80 backdrop- rounded-3xl p-4 sm:p-5 border border-slate-200/80 shadow-xl shadow-slate-200/50 w-full flex-1 overflow-hidden min-h-[420px] lg:min-h-0 lg:absolute lg:inset-0">
                {Platform.OS === "web" && (
                ...
                >
                  {PRIORITY_TASKS.map((task: any) => (
                    ...
                    >
                      {Platform.OS === "web" && (
                        <View
                          className={`absolute left-0 top-0 bottom-0 w-1 ${task.bg} opacity-0 group-hover:opacity-100 transition-opacity`}
                        />
                      )}
                      <View
                        className={`w-12 h-12 rounded-2xl items-center justify-center shadow-sm border border-white group-hover:-translate-y-0.5 transition-transform ${task.bg}`}
        ...
        <View className="mb-6 px-2">
          <Animated.View className="bg-white rounded-3xl p-6 sm:p-8 flex-col border border-slate-200 relative overflow-hidden min-h-[300px]">
            <MaterialCommunityIcons
              name="shield-check"
              size={180}
              color="#f3e8ff"
            ...
            <View className="flex-row items-center justify-between mb-6 z-10">
              ...
              <View className="flex-row items-center gap-2">
                <Pressable
                  onPress={() => onNavigate("passport")}
                  className="bg-purple-50 hover:bg-purple-100 px-4 py-2.5 rounded-xl border border-purple-200 flex-row items-center justify-center transition-colors cursor-pointer min-w-[70px]"
                >
                  <Text className="text-purple-600 font-bold text-xs tracking-widest uppercase text-center">
                    More
                  </Text>
                ...
                <View className="flex-row items-center gap-1.5 ml-2 hidden sm:flex">
                  <Pressable
                    onPress={() =>
                      passportScrollRefWeb.current?.scrollTo({
                        x: Math.max(0, passportScrollXWeb.current - 160),
                        animated: true,
                      })
                    }
                  ...
                  <Pressable
                    onPress={() =>
                      passportScrollRefWeb.current?.scrollTo({
                        x: passportScrollXWeb.current + 160,
                        animated: true,
                      })
                    }
                    className="bg-slate-50 hover:bg-slate-100 w-10 h-10 rounded-xl items-center justify-center border border-slate-200 transition-colors cursor-pointer"
            ...
            >
              <ScrollView
                ...
                onScroll={(e) => {
                  passportScrollXWeb.current = e.nativeEvent.contentOffset.x;
                }}
                scrollEventThrottle={16}
              >
                {BADGES.map((badge, idx) => (
                  <Pressable
                    key={idx}
                    onPress={() => setSelectedBadge(badge)}
                    className="bg-white p-4 rounded-3xl border border-slate-200 w-36 h-36 items-center justify-center flex-col gap-4 active:scale-95 transition-transform hover:border-purple-300 cursor-pointer"
                  >
                    <View
                      className={`w-16 h-16 bg-${badge.color}-50 rounded-2xl items-center justify-center border border-${badge.color}-100`}
                    >
                      <Text className="text-4xl">{badge.icon}</Text>
                    </View>
                    <Text
                      className="text-slate-800 font-black text-sm text-center tracking-tight"
                      numberOfLines={1}
                    >
                      {badge.title}
                    </Text>
      ...
      >
        {selectedBadge && (
          <View className="py-2 items-center">
            ...
            <Pressable
              onPress={() => setSelectedBadge(null)}
              className="w-full bg-slate-900 py-4 rounded-xl items-center active:bg-slate-800 transition-colors shadow-md"
            >
              <Text className="text-white font-bold text-sm tracking-widest uppercase">
                Close
              </Text>
                ...
                >
                      ...
                      >
                        <View className="flex-row items-center gap-1.5 flex-1 pr-2">
                          <MaterialCommunityIcons
                            ...
                            size={12}
                            color={
                              ass.status === "Completed" ? "#10b981" : "#d97706"
                            }
                          />
                          <Text
                            className="text-slate-600 text-xs font-medium flex-1"
                  ...
                  >
                    <MaterialCommunityIcons
                      ...
                      className={`text-${sub.color}-700`}
                    />
                    <Text className={`text-${sub.color}-700 font-bold text-xs`}>
                      Open Class Assessments
                    </Text>
                  </TouchableOpacity>
                </View>
        ...
        <View className="py-2 w-full">
          ...
          <View className="flex-row gap-3 w-full">
            ...
            <Pressable
              ...
              className="flex-[2] bg-purple-600 py-3.5 rounded-xl items-center active:bg-purple-750 transition-colors"
            >
              <Text className="text-white font-bold text-sm">
                View Passport
              </Text>
        ...
        <View className="py-2 w-full">
          ...
          <View className="flex-row gap-3 w-full">
            ...
            <Pressable
              ...
              className="flex-[2] bg-emerald-600 py-3.5 rounded-xl items-center active:bg-emerald-700 transition-colors"
            >
              <Text className="text-white font-bold text-sm">Open Classes</Text>
            </Pressable>
          </View>
        </View>
      </GlobalModal>
        ...
        <View className="py-2 w-full">
          ...
          <View className="flex-row gap-3 w-full">
            ...
            <Pressable
              ...
              className="flex-[2] bg-amber-600 py-3.5 rounded-xl items-center active:bg-amber-700 transition-colors"
            >
              <Text className="text-white font-bold text-sm">
                Open Communities
              </Text>
