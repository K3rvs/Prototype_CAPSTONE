...
import {
  CLASS_DATA_MAP,
  SHARED_CLASSES,
} from "@/components/shared/StudentMockData";
...
export const StudentClasses = ({
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      role: "ai",
      text: "Hello! I'm your AI Tutor for this class. I can help explain concepts from the uploaded materials, guide you through practice problems, or clarify the syllabus. How can I help you today?",
    },
  ]);
  ...
  const currentClassData = selectedClass
    ? CLASS_DATA_MAP[selectedClass.id.toString()]
    : null;
      ...
      if (lowerText.includes("quiz") || /\btest\b/i.test(lowerText)) {
        ...
        if (lowerText.includes("identification")) {
          ...
          if (classId === "2") {
            generatedQuestions = [
              ...
              {
                type: "Identification",
                q: "3. A polygon with 3 sides is a ________.",
                ans: "triangle",
              },
              {
                type: "Identification",
                q: "4. The set of all possible input values of a function is the ________.",
                ans: "domain",
              },
              {
                type: "Identification",
                q: "5. A line that a curve approaches but never touches is an ________.",
                ans: "asymptote",
              },
            ];
          } else if (classId === "3") {
            generatedQuestions = [
              {
                type: "Identification",
                q: "1. Giving human traits to non-human things or animals is called ________.",
                ans: "personification",
              },
              {
                type: "Identification",
                q: "2. The perspective from which a story is narrated is called the ________ of view.",
                ans: "point",
              },
              {
                type: "Identification",
                q: "3. A direct comparison between two things without using 'like' or 'as' is a ________.",
                ans: "metaphor",
              },
              {
                type: "Identification",
                q: "4. The main character in a story, often the hero, is the ________.",
                ans: "protagonist",
              },
              {
                type: "Identification",
                q: "5. The opposing character or force against the main character is the ________.",
                ans: "antagonist",
              },
            ];
          } else {
            ...
            generatedQuestions = [
              {
                type: "Identification",
                q: "1. The variable that is manipulated by the researcher is called the ________ variable.",
                ans: "independent",
              },
              {
                type: "Identification",
                q: "2. An educated guess or prediction about the relationship between variables is a ________.",
                ans: "hypothesis",
              },
              {
                type: "Identification",
                q: "3. The entire group of individuals that a researcher is interested in studying is the ________.",
                ans: "population",
              },
              {
                type: "Identification",
                q: "4. The consistency of a research measurement instrument is known as ________.",
                ans: "reliability",
              },
              {
                type: "Identification",
                q: "5. A subset of the population chosen for actual study is the ________.",
                ans: "sample",
              },
              {
                type: "Identification",
                q: "6. The degree to which an instrument measures what it is supposed to measure is ________.",
                ans: "validity",
              },
              {
                type: "Identification",
                q: "7. A non-probability sampling technique where subjects are selected because of their convenient accessibility is ________ sampling.",
                ans: "convenience",
              },
              {
                type: "Identification",
                q: "8. A variable that is kept constant to prevent it from influencing the effect of the independent variable is a ________ variable.",
                ans: "control",
              },
              {
                type: "Identification",
                q: "9. Data that is expressed in numbers and can be analyzed statistically is ________ data.",
                ans: "quantitative",
              },
              {
                type: "Identification",
                q: "10. The most frequently occurring value in a dataset is the ________.",
                ans: "mode",
              },
            ];
          }
          ...
          if (classId === "2") {
            generatedQuestions = [
              ...
              {
                type: "Enumeration",
                q: "2. Select two prime numbers:",
                options: ["2", "3", "4", "6"],
                ans: ["2", "3"],
              },
              {
                type: "Enumeration",
                q: "3. Select two perfect squares:",
                options: ["16", "25", "30", "50"],
                ans: ["16", "25"],
              },
              {
                type: "Enumeration",
                q: "4. Select two operations in PEMDAS:",
                options: [
                  "Multiplication",
                  "Addition",
                  "Fraction",
              ...
              {
                type: "Enumeration",
                q: "5. Select two types of functions:",
                options: ["Linear", "Rational", "Square", "Hexagonal"],
                ans: ["Linear", "Rational"],
              },
            ];
          } else if (classId === "3") {
            generatedQuestions = [
              {
                type: "Enumeration",
                q: "1. Select two figures of speech:",
                options: ["Simile", "Metaphor", "Rhythm", "Stanza"],
                ans: ["Simile", "Metaphor"],
              },
              {
                type: "Enumeration",
                q: "2. Select two canonical playwrights:",
                options: [
                  "Shakespeare",
                  "Arthur Miller",
                  "Isaac Newton",
              ...
              {
                type: "Enumeration",
                q: "3. Select two elements of a story:",
                options: ["Plot", "Setting", "Equation", "Syllable"],
                ans: ["Plot", "Setting"],
              },
              {
                type: "Enumeration",
                q: "4. Select two types of literary conflict:",
                options: [
                  "Man vs Self",
                  "Man vs Society",
                  "Cat vs Dog",
                ...
                ans: ["Man vs Self", "Man vs Society"],
              },
              {
                type: "Enumeration",
                q: "5. Select two genres of poetry:",
                options: ["Sonnet", "Haiku", "Novel", "Play"],
                ans: ["Sonnet", "Haiku"],
              },
            ];
          } else {
            ...
            generatedQuestions = [
              ...
              {
                type: "Enumeration",
                q: "2. Select two probability sampling techniques:",
                options: [
                  "Simple Random",
                  "Stratified Random",
                  "Convenience",
                ...
                ans: ["Simple Random", "Stratified Random"],
              },
              {
                type: "Enumeration",
                q: "3. Select two main sections of Chapter 1 (Introduction):",
                options: [
              ...
              {
                type: "Enumeration",
                q: "4. Select two levels of measurement:",
                options: ["Nominal", "Ordinal", "Heavy", "Celsius"],
                ans: ["Nominal", "Ordinal"],
              },
              {
                type: "Enumeration",
                q: "5. Select two measures of central tendency:",
                options: ["Mean", "Median", "Standard Deviation", "Range"],
                ans: ["Mean", "Median"],
              },
              {
                type: "Enumeration",
                q: "6. Select two types of validity:",
                options: [
                  "Content Validity",
                  "Construct Validity",
                  "Random Validity",
                ...
                ans: ["Content Validity", "Construct Validity"],
              },
              {
                type: "Enumeration",
                q: "7. Select two types of reliability tests:",
                options: ["Test-Retest", "Split-Half", "Qualitative", "ANOVA"],
                ans: ["Test-Retest", "Split-Half"],
              },
              {
                type: "Enumeration",
                q: "8. Select two types of continuous data:",
                options: ["Interval", "Ratio", "Nominal", "Categorical"],
                ans: ["Interval", "Ratio"],
              },
              {
                type: "Enumeration",
                q: "9. Select two inferential statistics tests:",
                options: ["t-Test", "ANOVA", "Mean", "Mode"],
                ans: ["t-Test", "ANOVA"],
              },
              {
                type: "Enumeration",
                q: "10. Select two non-probability sampling methods:",
                options: ["Purposive", "Snowball", "Stratified", "Cluster"],
                ans: ["Purposive", "Snowball"],
              },
            ];
          }
        } else {
          ...
          if (classId === "2") {
            generatedQuestions = [
              {
                ...
                q: "1. Evaluate the function f(x) = 2x - 3 for x = 5.",
                options: ["3", "5", "7", "10"],
                ans: "7",
              },
              {
                type: "Multiple Choice",
                q: "2. What is the vertical asymptote of the rational function f(x) = 1 / (x - 2)?",
                options: ["x = 0", "x = 2", "x = -2", "x = 1"],
                ans: "x = 2",
              },
              {
                type: "Multiple Choice",
                q: "3. If f(x) = x^2 and g(x) = x + 1, find the composite function (f ∘ g)(2).",
                options: ["5", "6", "9", "8"],
                ans: "9",
              },
              {
                type: "Multiple Choice",
                q: "4. What is the inverse function of f(x) = x + 4?",
                options: [
                  "f^-1(x) = x - 4",
                  "f^-1(x) = 4 - x",
                  "f^-1(x) = 4x",
              ...
              {
                type: "Multiple Choice",
                q: "5. Which of the following is a logarithmic expression of 2^3 = 8?",
                options: [
                  "log_2(8) = 3",
                  "log_8(2) = 3",
                  "log_3(8) = 2",
            ...
            generatedQuestions = [
              {
                type: "Multiple Choice",
                q: "1. What literary device is a comparison using 'like' or 'as'?",
                options: ["Metaphor", "Simile", "Personification", "Hyperbole"],
                ans: "Simile",
              },
              {
                type: "Multiple Choice",
                q: "2. Who is the author of 'Romeo and Juliet'?",
                options: [
                  "Geoffrey Chaucer",
                  "William Shakespeare",
                  "John Milton",
              ...
              {
                type: "Multiple Choice",
                q: "3. What is the central or underlying message of a story?",
                options: ["Setting", "Plot", "Theme", "Climax"],
                ans: "Theme",
              },
              {
                type: "Multiple Choice",
                q: "4. Which genre features magical elements in an otherwise realistic setting?",
                options: [
                  "Science Fiction",
                  "Magical Realism",
                  "High Fantasy",
              ...
              {
                type: "Multiple Choice",
                q: "5. What is a humorous, five-line poem with a rhyme scheme of AABBA?",
            ...
            generatedQuestions = [
              {
                type: "Multiple Choice",
                q: "1. What research design involves investigating a phenomenon through numerical data?",
                options: [
                  "Qualitative",
                  "Quantitative",
                  "Historical",
              ...
              {
                type: "Multiple Choice",
                q: "2. Which sampling method gives every member of the population an equal chance of selection?",
                options: [
                  "Convenience",
                  "Purposive",
                  "Simple Random",
              ...
              {
                type: "Multiple Choice",
                q: "3. What variable is affected by the independent variable?",
                options: ["Extraneous", "Control", "Dependent", "Moderator"],
                ans: "Dependent",
              },
              {
                type: "Multiple Choice",
                q: "4. Which of the following is a scale of measurement?",
                options: ["Heavy", "Nominal", "Bright", "Soft"],
                ans: "Nominal",
              },
              {
                type: "Multiple Choice",
                q: "5. What is the standard citation format used in Social Sciences?",
                options: ["MLA", "Chicago", "APA", "Harvard"],
                ans: "APA",
              },
              {
                type: "Multiple Choice",
                q: "6. A statement indicating no significant difference or relationship is known as a ________ hypothesis.",
                options: ["Alternative", "Null", "Directional", "Complex"],
                ans: "Null",
              },
              {
                type: "Multiple Choice",
                q: "7. Which measure of variability describes the spread of data around the mean?",
                options: ["Range", "Standard Deviation", "Mode", "Variance"],
                ans: "Standard Deviation",
              },
              {
                type: "Multiple Choice",
                q: "8. A study testing the effect of a new teaching method on student scores is an example of what design?",
                options: [
                  "Descriptive",
                  "Correlational",
                  "Experimental",
              ...
              {
                type: "Multiple Choice",
                q: "9. What is the process of selecting a subset of individuals from a population?",
                options: [
                  "Data Gathering",
                  "Sampling",
                  "Hypothesizing",
              ...
              {
                type: "Multiple Choice",
                q: "10. In a correlational study, what does a correlation coefficient of +0.9 indicate?",
                options: [
                  "Weak Positive",
                  "Strong Positive",
                  "No Correlation",
        ...
        if (classId === "2") {
          conceptData = {
            ...
            explanation:
              "Function composition is a process where the output of one function becomes the input of another function. The notation (f ∘ g)(x) is read as 'f of g of x', which means you evaluate g(x) first, then plug that result into f(x).",
            analogy:
              "🏭 Assembly Line Analogy: Think of functions as machines. Machine G takes raw metal (x) and shapes it into a gear (g(x)). Machine F takes that gear (g(x)) and paints it blue, outputting a finished blue gear (f(g(x))).",
            steps: [
          ...
          conceptData = {
            ...
            explanation:
              "Magical Realism is a literary genre where magical or supernatural elements are integrated naturally into an otherwise realistic, mundane environment. The characters react to magical events as if they are completely normal occurrences.",
            analogy:
              "☕ Sugar in Coffee Analogy: In fantasy, magic is like soda (clearly separate from normal water). In magical realism, magic is like sugar in coffee (it dissolves completely into the everyday cup, becoming part of the texture without standing out as alien).",
            steps: [
  ...
  const submitAiTest = () => {
    ...
    aiQuestions.forEach((q: any, i: number) => {
      if (q.type === "Enumeration") {
        const userAns = Array.isArray(aiAnswers[i])
          ? [...aiAnswers[i]].sort()
          : [];
        const correctAns = Array.isArray(q.ans) ? [...q.ans].sort() : [];
        if (
  ...
  const getLeaderboard = () => {
    ...
    if (
      activeTest &&
      (testPhase === "results" || activeTest.status === "Completed")
    ) {
      const userNickname =
  ...
  const testPercentage = Math.round(
    (testScore / (currentQuestions.length || 1)) * 100,
  );
  const isPerfect =
  ...
  const aiTestPercentage = Math.round(
    (aiTestScore / (aiQuestions.length || 1)) * 100,
  );
  const aiIsPerfect =
    aiTestScore === aiQuestions.length && aiQuestions.length > 0;
  const aiIsPassing = aiTestPercentage >= 60;
  const aiResultColor = aiIsPerfect
    ? "emerald"
    : aiIsPassing
      ? "indigo"
      : "rose";
  const aiResultMessage = aiIsPerfect
    ? "Perfect Score! 🏆"
    : aiIsPassing
      ? "Practice Passed! 👍"
      : "Needs Review. 💪";
          ...
          <Animated.View className="flex-1 bg-slate-50/50 overflow-hidden flex-col w-full h-full relative">
            <View className="flex-1 flex-col h-full w-full relative bg-slate-50/50">
              ...
              {subTab === "announcements" && (
                <View
                  className={`bg-${selectedClass.color}-600 p-5 sm:p-6 flex-row items-center justify-between shadow-inner relative overflow-hidden group shrink-0 rounded-2xl`}
                >
                  ...
                  <View className="flex-1 pr-4 z-10">
                    ...
                    <View className="flex-row items-center gap-3 flex-wrap">
                      <View
                        className={`bg-${selectedClass.color}-700/50 px-3 py-1 rounded border border-${selectedClass.color}-500`}
                      >
                      ...
                      <Text
                        className={`text-${selectedClass.color}-100 font-medium text-sm`}
                      >
                ...
                {Platform.OS === "web" && (
                  <View className="hidden xl:flex w-48 flex-col gap-2 shrink-0">
                    ...
                    {CLASS_TABS.map((t) => (
                      ...
                      >
                        <View
                          className={`w-7 h-7 bg-${selectedClass.color}-50 rounded-lg items-center justify-center border border-${selectedClass.color}-100`}
                        >
                          <MaterialCommunityIcons
                            name={t.icon as any}
                            size={16}
                            className={`text-${selectedClass.color}-600`}
                          />
                        </View>
                        <Text
                          className={`font-bold text-xs sm:text-sm flex-1 ${subTab === t.id ? `text-${selectedClass.color}-800` : "text-slate-700"}`}
                        >
                          {t.label}
                        </Text>
                      </Pressable>
                      ...
                      <Animated.View className="flex-1 flex-col pb-8 relative z-20">
                        <View className="flex-col sm:flex-row justify-between sm:items-center mb-4 gap-3 border-b border-slate-200 pb-3 bg-white p-4 sm:p-5 rounded-2xl shadow-sm z-10">
                          <View className="flex-1">
                            ...
                            <Text className="text-slate-500 text-xs sm:text-sm mt-1 leading-relaxed font-medium">
                              Broadcast updates directly from{" "}
                        ...
                        <View className="px-1 pb-8 pt-1 gap-3">
                          {ANNOUNCEMENTS.map((a, i) => (
                            <Animated.View
                              key={a.id}
                              className={`bg-white border rounded-xl p-4 shadow-sm flex-col relative overflow-hidden ${a.isPinned ? `border-${selectedClass.color}-400 shadow-${selectedClass.color}-500/10` : "border-slate-200"}`}
                            >
                              {a.isPinned && (
                                <View
                                  className={`absolute top-0 right-0 bg-${selectedClass.color}-500 px-3 py-1 rounded-bl-lg z-10 shadow-sm`}
                                >
                              ...
                              <View className="flex-row items-center gap-3 mb-3">
                                <View
                                  className={`w-8 h-8 rounded-full border border-${selectedClass.color}-50 bg-${selectedClass.color}-100 overflow-hidden items-center justify-center shadow-sm`}
                                >
                                  <Image
                              ...
                              <View className="flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-slate-100 mt-auto">
                                <View className="flex-row flex-wrap gap-1.5 flex-1">
                                  {a.attachments &&
                                    a.attachments.map((file, fIdx) => (
                                      <View
                                        key={fIdx}
                                        className="flex-row items-center gap-1 bg-slate-50 border border-slate-200 px-2 py-1 rounded-md"
                                      >
                                        <MaterialCommunityIcons
                                          name="paperclip"
                                          size={12}
                                          className={`text-${selectedClass.color}-700`}
                                        />
                                        <Text className="text-slate-700 text-[10px] font-bold">
                                          {file}
                                        </Text>
                                      </View>
                                    ))}
                    ...
                    <Animated.View className="flex-1 flex-col relative">
                      <View className="flex-row items-center justify-between px-4 sm:px-6 lg:px-8 py-3 z-10 shrink-0 border-b border-slate-100 bg-white/50 backdrop-">
                        <View className="flex-row items-center gap-2.5">
                          <View
                            className={`w-7 h-7 items-center justify-center bg-${selectedClass.color}-100 rounded-full border border-${selectedClass.color}-200`}
                          >
                            <MaterialCommunityIcons
                              name="robot-outline"
                              size={14}
                          ...
                          <View>
                            ...
                            <Text
                              className={`text-${selectedClass.color}-600 text-[9px] font-bold uppercase tracking-widest`}
                            >
                              Context: Class Materials
                            </Text>
                          </View>
                        </View>
                        <View className="flex-row items-center gap-1.5 flex-shrink-0">
                          <Pressable
                            ...
                            className="w-7 h-7 sm:w-auto sm:px-2.5 sm:py-1.5 rounded-md items-center justify-center sm:justify-start flex-row gap-1.5 bg-white hover:bg-slate-50 active:bg-slate-100 transition-colors border border-slate-200 shadow-sm"
                          >
                            <MaterialCommunityIcons
                              name="history"
                              size={14}
                              color="#475569"
                            />
                            <Text className="text-slate-700 font-bold text-xs hidden sm:flex">
                              History
                            </Text>
                          </Pressable>
                          <Pressable
                            onPress={() => setNewChatModal(true)}
                            className={`w-7 h-7 sm:w-auto sm:px-2.5 sm:py-1.5 rounded-md items-center justify-center sm:justify-start flex-row gap-1.5 bg-${selectedClass.color}-600 hover:bg-${selectedClass.color}-700 active:bg-${selectedClass.color}-800 transition-colors border border-${selectedClass.color}-700 shadow-sm shadow-${selectedClass.color}-500/30`}
                          >
                            <MaterialCommunityIcons
                              name="plus"
                              size={14}
                              color="white"
                            />
                            <Text className="text-white font-bold text-xs hidden sm:flex">
                              New Chat
                            </Text>
                          </Pressable>
                        </View>
                            ...
                            >
                              {msg.role === "user" ? (
                                <View className="self-end max-w-[85%] sm:max-w-[75%]">
                                  <View
                                    className={`bg-${selectedClass.color}-600 px-3.5 py-2 rounded-xl rounded-tr-sm shadow-sm`}
                                  >
                                    <Text
                                ...
                                <View className="self-start w-full">
                                  <View className="flex-row items-center gap-2 mb-1.5 px-1">
                                    <View
                                      className={`w-5 h-5 bg-${selectedClass.color}-600 rounded-full items-center justify-center shadow-sm`}
                                    >
                                      <MaterialCommunityIcons
                                        name="robot-outline"
                                        size={12}
                                    ...
                                    <Text
                                      className={`text-${selectedClass.color}-800 font-bold text-[10px]`}
                                    >
                                      AI Tutor
                                    </Text>
                                  </View>
                                      ...
                                      <View className="mt-4 bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-sm hover:border-indigo-300 transition-colors">
                                        <View className="flex-row items-center gap-2 mb-3">
                                          <MaterialCommunityIcons
                                            ...
                                            className={`text-${selectedClass.color}-600`}
                                          />
                                          <Text className="font-black text-slate-800 text-sm sm:text-base">
                                            {msg.summaryData.title}
                                          </Text>
                                        </View>
                                        <Text className="text-slate-600 text-xs sm:text-sm leading-relaxed mb-4">
                                          {msg.summaryData.text}
                                        </Text>
                                        ...
                                        <View className="bg-slate-50/50 rounded-xl p-3 border border-slate-100 gap-2">
                                          ...
                                          {msg.summaryData.bulletPoints.map(
                                            (bp: string, bpIdx: number) => (
                                              <View
                                                key={bpIdx}
                                              ...
                                              >
                                                <MaterialCommunityIcons
                                                  name="check-bold"
                                                  size={14}
                                                  className={`text-${selectedClass.color}-500 mt-0.5 shrink-0`}
                                                />
                                                <Text className="text-slate-700 text-xs leading-relaxed flex-1 font-medium">
                                                  {bp}
                                                </Text>
                                              </View>
                                            ),
                                    ...
                                    {msg.isConcept && msg.conceptData && (
                                      <View className="mt-4 bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-sm hover:border-indigo-300 transition-colors">
                                        <View className="flex-row items-center gap-2 mb-3">
                                          ...
                                          />
                                          <Text className="font-black text-slate-800 text-sm sm:text-base">
                                            Concept: {msg.conceptData.concept}
                                          </Text>
                                        </View>
                                        <Text className="text-slate-600 text-xs sm:text-sm leading-relaxed mb-4">
                                          {msg.conceptData.explanation}
                                        </Text>
                                        ...
                                        <View className="bg-amber-50/30 border border-amber-200/50 rounded-xl p-3 mb-4 flex-row items-start gap-2">
                                          ...
                                          />
                                          <View className="flex-1">
                                            <Text className="text-[10px] font-black text-amber-800 uppercase tracking-widest mb-0.5">
                                              Analogy
                                            </Text>
                                            <Text className="text-slate-700 text-xs leading-relaxed font-medium">
                                              {msg.conceptData.analogy}
                                            </Text>
                                          </View>
                                        </View>
                                        ...
                                        <View className="gap-2.5">
                                          ...
                                          {msg.conceptData.steps.map(
                                            (step: string, stepIdx: number) => (
                                              ...
                                              >
                                                <View
                                                  className={`w-5 h-5 bg-${selectedClass.color}-50 border border-${selectedClass.color}-200 rounded-full items-center justify-center`}
                                                >
                                                  <Text
                                                    className={`text-${selectedClass.color}-700 font-bold text-[10px]`}
                                                  >
                                                    {stepIdx + 1}
                                                  </Text>
                                                </View>
                                  ...
                                  <View className="flex-row items-center justify-start gap-1 mt-3 px-1">
                                    ...
                                    <Pressable
                                      className="p-2 rounded-full hover:bg-emerald-50 active:bg-emerald-100 transition-colors group"
                                      onPress={() =>
                                    ...
                                    <Pressable
                                      className="p-2 rounded-full hover:bg-rose-50 active:bg-rose-100 transition-colors group"
                                      onPress={() =>
                                        alert("Feedback submitted")
                                      }
                                      hitSlop={8}
                                    ...
                                    !isSimulating && (
                                      <Animated.View className="w-full mt-4">
                                        <ScrollView
                                          ...
                                          contentContainerClassName="gap-3 pb-2 px-1"
                                          className="w-full [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-slate-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-slate-300"
                                        >
                                          {[
                                            {
                                            ...
                                            },
                                            {
                                              ...
                                              prompt:
                                                "Create an Identification Quiz",
                                              icon: "form-textbox",
                                            },
                                            {
                                              label: "Enumeration Quiz",
                                              prompt:
                                            ...
                                            },
                                            {
                                              ...
                                              prompt:
                                                "Summarize the latest topic",
                                              icon: "text-box-outline",
                                            },
                                            {
                                              label: "Explain Concept",
                                              prompt:
                                                "Explain an advanced concept",
                                              icon: "brain",
                                            },
                                            ...
                                            <Pressable
                                              ...
                                              className={`bg-white border border-slate-200 py-1.5 px-3 rounded-full shadow-sm flex-row items-center gap-1.5 active:scale-95 transition-transform hover:border-${selectedClass.color}-300 hover:bg-${selectedClass.color}-50`}
                                            >
                                              <MaterialCommunityIcons
                                                ...
                                                className={`text-${selectedClass.color}-600`}
                                              />
                                              <Text className="font-bold text-slate-700 text-[10px] sm:text-xs">
                                                {action.label}
                                              </Text>
                                            </Pressable>
                                          ))}
                            ...
                            <Animated.View className="flex-col w-full mb-2">
                              <View className="self-start w-full">
                                <View className="flex-row items-center gap-2 mb-1.5 px-1">
                                  ...
                                  <Text
                                    className={`text-${selectedClass.color}-700 font-bold text-[10px] uppercase tracking-widest`}
                                  >
                                    AI Tutor
                                  </Text>
                                </View>
                                <View className="px-1 py-2 flex-row gap-1.5 items-center h-8">
                                  <View
                                    className={`w-2 h-2 bg-${selectedClass.color}-400 rounded-full animate-bounce`}
                                  />
                                  <View
                                    className={`w-2 h-2 bg-${selectedClass.color}-500 rounded-full animate-bounce`}
                                    style={{ animationDelay: "0.15s" } as any}
                                  />
                                  <View
                                    className={`w-2 h-2 bg-${selectedClass.color}-600 rounded-full animate-bounce`}
                      ...
                      >
                        ...
                        >
                          <View
                            className={`bg-white/80 rounded-2xl border border-slate-200/80 focus-within:bg-white focus-within:border-${selectedClass.color}-400 focus-within:shadow-xl transition-all shadow-sm flex-row items-end px-2 py-1.5 w-full gap-2`}
                          >
                            ...
                            <Pressable
                              ...
                              className={`h-8 w-8 rounded-full items-center justify-center transition-all active:scale-95 ${inputText.trim() ? `bg-${selectedClass.color}-600 hover:bg-${selectedClass.color}-700 shadow-md shadow-${selectedClass.color}-500/30` : "bg-slate-300"}`}
                            >
                              <MaterialCommunityIcons
                                name="arrow-up"
                                size={18}
                          ...
                          <Text className="text-center text-slate-500 text-[10px] mt-1.5 font-medium px-4">
                            Classroom AI can make mistakes. Consider verifying
                      ...
                      {subTab === "materials" && (
                        <Animated.View className="gap-3">
                          <View className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm z-10 flex-col justify-center">
                            <Text className="text-lg sm:text-xl font-black text-slate-800 mb-1">
                              Class Materials
                            </Text>
                            <Text className="text-slate-500 text-xs sm:text-sm font-medium">
                              Resources uploaded by {selectedClass.teacher}.
                              These also serve as the knowledge base for the AI
                              Tutor.
                            </Text>
                          </View>
                          <View className="flex-col gap-2">
                            {(currentClassData?.materials || []).map(
                              (m: any) => (
                                <View
                                  key={m.id}
                                  className="w-full bg-white p-3 sm:p-4 rounded-xl shadow-sm border border-slate-200 flex-row items-center justify-between gap-3 hover:shadow-md transition-shadow"
                                >
                                  <View className="flex-row items-center gap-3 flex-1">
                                    <View
                                      className={`w-10 h-10 bg-${selectedClass.color}-50 rounded-lg items-center justify-center border border-${selectedClass.color}-100 shrink-0`}
                                    >
                                      <MaterialCommunityIcons
                                        name={
                                          m.type.toLowerCase().includes("pdf")
                                            ? "file-pdf-box"
                                            : m.type
                                                  .toLowerCase()
                          ...
                          <View className="flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3 z-50 relative bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm">
                            <View>
                              ...
                              <Text className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
                                Formative modules designed by your instructor.
                              </Text>
                            </View>
                          ...
                          <View className="gap-3">
                            ...
                            {filteredAssessments.map((a: any) => (
                              <Pressable
                                ...
                                className={`bg-white p-3 sm:p-4 rounded-xl shadow-sm border flex-col sm:flex-row sm:items-center justify-between gap-3 transition-transform active:scale-[0.98] ${a.status === "Ongoing" ? "border-rose-300" : a.status === "Upcoming" ? "border-amber-200 opacity-80" : "border-emerald-200"}`}
                              >
                                <View className="flex-row items-center gap-3 flex-1">
                                  <View
                                ...
                                <View className="items-start sm:items-end flex-row sm:flex-col gap-2 w-full sm:w-auto mt-2 sm:mt-0 pt-2 sm:pt-0 border-t border-slate-100 sm:border-0">
                                  <View
                                    className={`px-2 py-1 rounded border ${a.status === "Ongoing" ? "bg-rose-100 border-rose-200" : a.status === "Upcoming" ? "bg-amber-100 border-amber-200" : "bg-emerald-100 border-emerald-200"}`}
                                  >
                                    <Text
                    ...
                    <Animated.FlatList
                        ...
                        <View className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm z-10 flex-row justify-between items-center mb-4">
                          <View>
                            ...
                            <Text className="text-slate-500 text-xs sm:text-sm mt-0.5 font-medium">
                              {CLASSMATES.length} Peers enrolled in{" "}
                              {selectedClass.section}
                            </Text>
                          </View>
                        </View>
                      ...
                      renderItem={({ item: peer }: any) => (
                        <Pressable
                          ...
                          className="w-full mb-2 bg-white border border-slate-200 p-3 sm:p-4 rounded-xl shadow-sm flex-row items-center justify-between gap-3 hover:border-sky-300 hover:shadow-md transition-all active:scale-[0.98]"
                        >
                          <View className="flex-row items-center gap-3">
                            <View
                              className={`w-10 h-10 rounded-full items-center justify-center bg-slate-100 border border-slate-200 shadow-sm`}
                            >
                              <Text className="font-black text-slate-600 text-base">
                                {peer.avatar}
                              </Text>
                            </View>
                            <View>
                  ...
                  {CLASS_TABS.map((t) => (
                    ...
                    >
                      <MaterialCommunityIcons
                        ...
                        className={
                          subTab === t.id
                            ? `text-${selectedClass.color}-600`
                            : "text-slate-500"
                        }
                      />
                      <Text
                        className={`text-[10px] font-bold text-center ${subTab === t.id ? `text-${selectedClass.color}-700` : "text-slate-500"}`}
                        numberOfLines={1}
                      >
                        {t.label}
                      </Text>
            ...
            <GlobalModal
              ...
              title="Examination Verification"
            >
              <View className="items-center py-6">
                ...
                <Text className="text-slate-600 text-center px-6 mb-8 leading-relaxed font-medium">
                  Once you start the ongoing examination, the Classroom AI and
                  other tabs will be{" "}
            ...
            >
              <View className="items-center mb-8 mt-2">
                <View
                  className={`w-24 h-24 bg-${selectedClass?.color || "sky"}-50 rounded-full border-[6px] border-${selectedClass?.color || "sky"}-100 items-center justify-center mb-6 shadow-sm`}
                >
                  <MaterialCommunityIcons
                    name="message-plus-outline"
                    size={40}
                    className={`text-${selectedClass?.color || "sky"}-600`}
                  />
                </View>
                ...
                <Text className="text-slate-600 text-center text-base px-4 leading-relaxed font-medium">
                  This will clear the current conversational context from the
                  workspace window. Your previous chat will be saved in History.
                </Text>
              </View>
              ...
              >
                <View className="gap-3 mt-2 mb-6">
                  {[
                    {
                      id: 1,
                      title: "Explanation: Limits and Continuity",
                      date: "Today, 10:30 AM",
                      messages: 12,
                    },
                    {
                      id: 2,
                      title: "Practice Quiz: Derivatives",
                    ...
                    <Pressable
                      ...
                      className={`bg-slate-50 border border-slate-200 p-4 rounded-2xl flex-row items-center justify-between active:bg-slate-100 hover:border-${selectedClass?.color || "sky"}-300 transition-colors group`}
                    >
                      <View className="flex-row items-center gap-4 flex-1 pr-4">
                        <View
                          className={`w-10 h-10 bg-white rounded-full items-center justify-center shadow-sm border border-slate-200 group-hover:border-${selectedClass?.color || "sky"}-200 transition-colors`}
                        >
                          <MaterialCommunityIcons
                      ...
                      <MaterialCommunityIcons
                        ...
                        size={24}
                        color="#cbd5e1"
                        className={`group-hover:text-${selectedClass?.color || "sky"}-600 transition-colors`}
                      />
                    </Pressable>
                  ))}
                </View>
                ...
                >
                  {aiTestPhase === "testing" && aiQuestions[aiCurrentQ] && (
                    <View className="flex-1 max-w-3xl w-full mx-auto justify-center">
                      <View className="flex-row justify-between items-center mb-6">
                        <View>
                          <Text className="font-bold text-slate-500 text-lg mb-1">
                            Question {aiCurrentQ + 1} of {aiQuestions.length}
                          </Text>
                        ...
                        <View className="bg-slate-50 px-4 py-2 rounded-2xl border border-slate-200 flex-row items-center gap-2 shadow-sm">
                          <MaterialCommunityIcons
                            name="timer-outline"
                            size={20}
                            color={aiTimeLeft < 60 ? "#ef4444" : "#64748b"}
                          />
                          <Text
                            className={`font-black text-lg font-mono tracking-widest ${aiTimeLeft < 60 ? "text-red-500" : "text-slate-700"}`}
                          >
                            {formatTime(aiTimeLeft)}
                          </Text>
                        </View>
                      </View>
                      <View className="w-full bg-slate-200 h-2 rounded-full mb-10 overflow-hidden">
                        <View
                          className={`bg-${selectedClass?.color || "sky"}-600 h-full rounded-full transition-all`}
                          style={
                            {
                              width: `${((aiCurrentQ + 1) / aiQuestions.length) * 100}%`,
                            } as any
                          }
                        />
                      </View>
                      ...
                      <Text className="text-2xl sm:text-3xl font-black text-slate-800 mb-8 leading-tight">
                        {aiQuestions[aiCurrentQ].q}
                      </Text>

                      {aiQuestions[aiCurrentQ].type === "Multiple Choice" && (
                        <View className="gap-4">
                          {aiQuestions[aiCurrentQ].options?.map(
                      ...
                      {aiQuestions[aiCurrentQ].type === "Enumeration" && (
                        <View className="gap-4">
                          ...
                          {aiQuestions[aiCurrentQ].options?.map(
                            (opt: string, optIdx: number) => {
                              const isSelected =
                                Array.isArray(aiAnswers[aiCurrentQ]) &&
                                aiAnswers[aiCurrentQ].includes(opt);
                      ...
                      <View className="flex-row justify-between mt-12 pt-6 border-t border-slate-200">
                        <Pressable
                          onPress={() =>
                            setAiCurrentQ(Math.max(0, aiCurrentQ - 1))
                          }
                          disabled={aiCurrentQ === 0}
                          className={`px-8 py-4 rounded-xl transition-colors ${aiCurrentQ === 0 ? "opacity-50 bg-slate-100" : "bg-slate-200 active:bg-slate-300"}`}
                        >
                        ...
                        {aiCurrentQ === aiQuestions.length - 1 ? (
                          ...
                          <Pressable
                            onPress={() => setAiCurrentQ(aiCurrentQ + 1)}
                            className={`px-8 py-4 bg-${selectedClass?.color || "sky"}-600 rounded-xl shadow-md shadow-${selectedClass?.color || "sky"}-500/30 active:bg-${selectedClass?.color || "sky"}-700 transition-transform active:scale-95`}
                          >
                            <Text className="font-bold text-white">
                              Next Question
                            </Text>
                  ...
                  {aiTestPhase === "results" && (
                    <View className="flex-1 items-center max-w-3xl mx-auto w-full py-4">
                      <View
                        className={`w-16 h-16 rounded-full border-[3px] border-${aiResultColor}-100 bg-${aiResultColor}-50 items-center justify-center mb-3 shadow-sm`}
                      >
                        <MaterialCommunityIcons
                          name={
                            aiIsPerfect
                          ...
                          size={28}
                          className={`text-${aiResultColor}-500`}
                        />
                      </View>
                        ...
                        <View className="flex-[1.1] bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex-col">
                          <View className="flex-row items-center justify-between mb-3">
                            ...
                            <View className="flex-row gap-1.5">
                              <Pressable
                                onPress={() =>
                                  setAiLbPage(Math.max(0, aiLbPage - 1))
                                }
                                className={`p-1 rounded-md border border-slate-200 active:bg-slate-100 ${aiLbPage === 0 ? "opacity-40" : ""}`}
                              >
                                <MaterialCommunityIcons
                                  name="chevron-left"
                                  size={16}
                              ...
                              <Pressable
                                onPress={() =>
                                  setAiLbPage(
                                    Math.min(
                                      Math.ceil(getAiLeaderboard().length / 6) -
                                        1,
                                      aiLbPage + 1,
                                    ),
                                  )
                                }
                                className={`p-1 rounded-md border border-slate-200 active:bg-slate-100 ${aiLbPage >= Math.ceil(getAiLeaderboard().length / 6) - 1 ? "opacity-40" : ""}`}
                              >
                                <MaterialCommunityIcons
                                  name="chevron-right"
                                  size={16}
                          ...
                          <View className="gap-2 flex-1 justify-between">
                            {getAiLeaderboard()
                              .slice(aiLbPage * 6, (aiLbPage + 1) * 6)
                              .map((lb, idx) => {
                                const realIdx = aiLbPage * 6 + idx;
                                const isSelf =
                                  lb.name === (nickname || "Anonymous");
                                return (
                                  <View
                                    key={realIdx}
                                    className={`flex-row items-center justify-between p-2 rounded-xl border ${isSelf ? `bg-${aiResultColor}-50 border-${aiResultColor}-200 shadow-sm scale-[1.02] transform transition-transform z-10` : "bg-slate-50 border-slate-100 hover:bg-slate-100 transition-colors"}`}
                                  >
                                    <View className="flex-row items-center gap-2.5">
                                      <View
                                      ...
                                      <View>
                                        <Text
                                          className={`font-black text-xs ${isSelf ? `text-${aiResultColor}-900` : "text-slate-800"}`}
                                        >
                                          {lb.name} {isSelf && "(You)"}
                                        </Text>
                                        {isSelf && (
                                          <Text
                                            className={`text-[8px] font-bold uppercase tracking-widest mt-0.5 text-${aiResultColor}-600`}
                                          >
                                            Your Score
                                          </Text>
                                        )}
                                    ...
                                    <View className="items-end bg-white px-2 py-1 rounded-lg border border-slate-200 shadow-sm">
                                      <Text
                                        className={`font-black text-xs ${isSelf ? `text-${aiResultColor}-700` : "text-slate-800"}`}
                                      >
                                        {lb.score}{" "}
                        ...
                        <View className="flex-1 bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex-col">
                          ...
                          <View className="flex-row items-center justify-between mb-3 bg-slate-50 p-3 sm:p-4 rounded-xl border border-slate-100">
                            <PieChart
                              data={[
                                {
                                  percent: aiTestPercentage,
                                  color:
                                    aiResultColor === "emerald"
                                      ? "#10b981"
                                      : aiResultColor === "indigo"
                                        ? "#6366f1"
                                        : "#f43f5e",
                                  label: "Correct",
                                },
                                {
                                  percent: 100 - aiTestPercentage,
                                  color: "#e2e8f0",
                                  label: "Incorrect",
                                },
                              ]}
                            ...
                            <View className="flex-1 ml-4 gap-2">
                              <View className="flex-row items-center justify-between">
                                <View className="flex-row items-center gap-1.5">
                                  <View
                                    className={`w-2 h-2 rounded-full bg-${aiResultColor}-500`}
                                  />
                              ...
                              <View className="flex-row items-center justify-between">
                                ...
                                <Text className="font-black text-slate-900 text-sm">
                                  {aiQuestions.length - aiTestScore}
                                </Text>
                              </View>
                              <View className="flex-row items-center justify-between pt-1.5 border-t border-slate-200">
                                ...
                                <Text
                                  className={`font-black text-xs text-${aiResultColor}-600`}
                                >
                                  {aiTestScore * 10} XP
                                </Text>
                              </View>
                      ...
                      <View className="w-full flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                        <Pressable
                          ...
                          className="bg-slate-200 py-2.5 rounded-xl items-center active:bg-slate-300 transition-colors"
                        >
                        ...
                        <Pressable
                          ...
                          className={`flex-[1.5] py-3 rounded-xl items-center shadow-md transition-colors bg-${aiResultColor}-600 active:bg-${aiResultColor}-700`}
                        >
                  ...
                  {testPhase === "results" && (
                    <View className="flex-1 items-center max-w-3xl mx-auto w-full py-4">
                      ...
                      <Text className="text-slate-500 font-medium text-center mb-5 px-4 text-xs">
                        ...
                        ! Here is a detailed breakdown of your assessment
                        performance.
                      </Text>
                            ...
                            <View className="flex-row gap-1.5">
                              ...
                              <Pressable
                                onPress={() =>
                                  setLbPage(
                                    Math.min(
                                      Math.ceil(getLeaderboard().length / 6) -
                                        1,
                                      lbPage + 1,
                                    ),
                                  )
            ...
            >
              <View className="py-2">
                <Text className="text-slate-600 mb-6 font-medium leading-relaxed px-1">
                  Upload your completed requirements here. Allowed formats: PDF,
                  DOCX, Images.
                </Text>
                ...
                <Pressable
                  ...
                  className="w-full bg-rose-600 py-4.5 rounded-2xl items-center active:bg-rose-700 shadow-md shadow-rose-500/30 transition-transform active:scale-95"
                >
                  <Text className="text-white font-bold text-base">
                    Upload & Submit
                  </Text>
              ...
              {peerModal && (
                <View className="items-center py-6">
                  ...
                  <View className="bg-sky-50 border border-sky-200 px-3 py-1 rounded-full mb-8">
                    <Text className="text-sky-700 font-bold text-[10px] uppercase tracking-widest">
                      {peerModal.role}
                    </Text>
                  </View>
                  <Pressable
              ...
              <View className="py-2 gap-4 w-full">
                    ...
                    {Array.from({ length: 42 }).map((_, i) => {
                      ...
                      return (
                        ...
                        >
                          {valid && (
                            <View
                              className={`w-full h-full items-center justify-center rounded-lg ${isStartOrEnd ? "bg-indigo-600 shadow-md shadow-indigo-500/30" : inRange ? "bg-indigo-100" : "bg-transparent hover:bg-slate-100"}`}
                            >
                              <Text
                                className={`text-xs sm:text-sm font-bold ${isStartOrEnd ? "text-white" : inRange ? "text-indigo-800" : "text-slate-700"}`}
                              >
                                {dateNum}
                              </Text>
                            </View>
                ...
                <View className="flex-row gap-3 mt-2 w-full">
                  ...
                  <Pressable
                    ...
                    className={`flex-[2] py-4 rounded-xl items-center shadow-md active:scale-95 transition-transform ${tempStart && tempEnd ? "bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 shadow-indigo-500/30" : "bg-indigo-300"}`}
                  >
                    <Text className="font-bold text-white">
                      Apply Date Range
                    </Text>
                    ...
                    return (
                      ...
                      >
                        <MaterialCommunityIcons
                          ...
                          className={
                            isActive
                              ? `text-${selectedClass.color}-700`
                              : "text-slate-500"
                          }
                        />
                        <Text
                          className={`text-[10px] font-bold mt-1 text-center ${isActive ? `text-${selectedClass.color}-800` : "text-slate-500"}`}
                          numberOfLines={1}
                        >
  ...
  return (
    ...
    >
            ...
            <View className="flex-1 flex-row items-center gap-4">
              ...
              <View className="flex-1">
                ...
                <Text className="text-slate-600 text-sm mt-1 leading-relaxed font-medium max-w-2xl">
                  Access your enrolled subjects, modules, and assessments
                  securely.
                </Text>
              </View>
            </View>
              ...
              >
                <Pressable
                  onPress={() => {
                    setSelectedClass(cls);
                    setSubTab("announcements");
                    if (onClassSelect) onClassSelect(cls.id.toString());
                  }}
      ...
      <GlobalModal
        isOpen={findSectionModal}
        onClose={() => setFindSectionModal(false)}
        title="Find Section"
      >
              ...
              >
                <View className="bg-white p-3 rounded-lg border border-slate-100 flex-col sm:flex-row justify-between sm:items-center mb-2 shadow-sm gap-2 sm:gap-0">
                  ...
                  <View className="flex-row items-center bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200 self-start sm:self-auto">
                    <Text className="text-slate-700 font-mono text-sm font-bold tracking-widest mr-2">
                      ABC123
                    </Text>
                    <Pressable
                      onPress={() => alert("Code Copied!")}
                      className="p-1 hover:bg-slate-200 active:bg-slate-300 rounded transition-colors"
                    >
                      <MaterialCommunityIcons
                        name="content-copy"
                        size={16}
        ...
        <View className="flex-row gap-3">
          <Pressable
            onPress={() => setFindSectionModal(false)}
            className="flex-1 bg-slate-100 py-4.5 rounded-2xl items-center border border-slate-200 active:bg-slate-200"
          >
      ...
      {/* Join By Code Modal */}
      <GlobalModal
        isOpen={joinCodeModal}
        onClose={() => setJoinCodeModal(false)}
      ...
      >
        ...
        <View className="flex-row gap-3">
          ...
          <Pressable
            ...
            className={`flex-[2] py-4.5 rounded-2xl items-center shadow-sm transition-all ${classCode.length === 6 ? "bg-sky-600 active:bg-sky-700 shadow-sky-500/30" : "bg-slate-300"}`}
          >
