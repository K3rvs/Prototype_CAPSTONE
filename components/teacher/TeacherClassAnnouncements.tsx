...
const yesterdayStr = new Date(today.getTime() - 86400000).toLocaleDateString(
  "en-US",
  { month: "short", day: "2-digit", year: "numeric" },
);
const lastWeekStr = new Date(today.getTime() - 86400000 * 7).toLocaleDateString(
  "en-US",
  { month: "short", day: "2-digit", year: "numeric" },
);
...
const INITIAL_ANNOUNCEMENTS = [
  {
    id: 8,
    title: "Reminder: Chapter 4 Quiz Tomorrow",
    body: "Don't forget to review the RAG sandbox for limits and continuity. The quiz will start strictly at 8:00 AM. Ensure your devices are fully charged and you have a stable internet connection. Good luck!",
    date: `${todayStr} • 04:00 PM`,
    author: "Teacher Jane",
    views: 42,
    isPinned: true,
    attachments: ["Quiz_Coverage.pdf"],
  },
  {
    id: 7,
    title: "Uploaded New Reading Materials",
    body: "I have added the latest DepEd memorandums and reading resources to our classroom directory. Please check them out before our next session to keep up with the discussions.",
    date: `${yesterdayStr} • 09:15 AM`,
    author: "Teacher Jane",
    views: 38,
    isPinned: false,
    attachments: ["DepEd_Memo_44.pdf", "Reading_List.docx"],
  },
  {
    id: 6,
    title: "Science Fair Registration Extended",
    body: "Good news! The deadline for the Science Fair registration has been extended until the end of the month. See me during consultation hours if you need help with your proposals.",
    date: `${lastWeekStr} • 01:30 PM`,
    author: "Teacher Jane",
    views: 45,
    isPinned: false,
    attachments: [],
  },
  {
    ...
    body: "Please remind your parents about the upcoming PTA meeting this Friday at the main hall. Attendance is highly encouraged as we will discuss the upcoming domain events.",
    date: `${new Date(today.getTime() - 86400000 * 9).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" })} • 10:00 AM`,
    author: "Teacher Jane",
    views: 40,
    isPinned: false,
    attachments: ["PTA_Agenda.pdf"],
  },
  {
    id: 4,
    title: "Adjusted Consultation Hours",
    body: "My consultation hours for this week will be moved to Thursday afternoon due to a sudden faculty meeting. Plan your inquiries accordingly.",
    date: `${new Date(today.getTime() - 86400000 * 12).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" })} • 03:45 PM`,
    author: "Teacher Jane",
    views: 35,
    isPinned: false,
    attachments: [],
  },
  {
    ...
    body: "The rubric for your mid-term group project is now available. Ensure all members contribute equally. Peer evaluations will be a significant part of the final grade calculation.",
    date: `${new Date(today.getTime() - 86400000 * 15).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" })} • 11:20 AM`,
    author: "Teacher Jane",
    views: 44,
    isPinned: false,
  ...
  },
  {
    ...
    body: "Welcome back, 12-STEM1! I am looking forward to a productive and engaging semester with all of you. Let's make this year count and aim for excellence.",
    date: `${new Date(today.getTime() - 86400000 * 20).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" })} • 08:00 AM`,
    author: "Teacher Jane",
    views: 45,
    isPinned: false,
    attachments: [],
  ...
  {
    id: 1,
    title: "Syllabus and Course Outline Available",
    body: "Please review the syllabus to understand our learning objectives and the grading system for this academic year. Feel free to ask questions if anything is unclear.",
    date: `${new Date(today.getTime() - 86400000 * 25).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" })} • 09:00 AM`,
    author: "Teacher Jane",
    views: 45,
    isPinned: false,
    attachments: ["Course_Syllabus_2026.pdf"],
  },
];
...
export const TeacherClassAnnouncements = ({
  ...
  const [announcements, setAnnouncements] = useState(
    classData?.announcements || INITIAL_ANNOUNCEMENTS,
  );
        ...
        {announcements.length === 0 && (
          <View className="items-center justify-center py-24 opacity-60 bg-white rounded-[2rem] border-2 border-dashed border-slate-300">
            <MaterialCommunityIcons
              ...
              color="#cbd5e1"
            />
            <Text className="text-2xl font-black text-slate-500 mt-4">
              No Announcements Yet
            </Text>
            <Text className="text-base text-slate-400 mt-2 text-center max-w-sm">
              Your broadcast history will appear here. Create a post to notify
              your students.
            </Text>
          </View>
        )}
        ...
        <View className="gap-5 mb-8 mt-2">
          ...
          <View>
            ...
            <Pressable className="w-full border-2 border-dashed border-teal-200 bg-teal-50/50 rounded-2xl p-6 items-center justify-center hover:bg-teal-50 transition-colors active:scale-[0.98]">
              ...
              <Text className="text-teal-900 font-bold text-sm">
      ...
      >
        <View className="items-center mb-10 mt-4">
          ...
          <Text className="text-slate-600 text-center text-base px-4 leading-relaxed">
            ...
            instantly removed from all student dashboards.
          </Text>
        </View>
