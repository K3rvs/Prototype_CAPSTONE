...
export const TeacherMasterSchedule = () => {
  ...
  const ALL_EVENTS = [
    { date: todayDay, title: "12-HUMSS Chapter 1-3 Defense", type: "Local Deadline", color: "orange" },
    { date: Math.min(todayDay + 4, 28), title: "11-STEM Literature Output", type: "Local Deadline", color: "orange" },
  ];
  ...
  return (
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={true} nestedScrollEnabled={true} className="flex-1 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
