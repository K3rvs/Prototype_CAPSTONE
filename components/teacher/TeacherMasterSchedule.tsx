...
export const TeacherMasterSchedule = () => {
  ...
  const monthIdx = todayDateObj.getMonth();
  ...
  return (
    ...
    >
      ...
      >
        <Animated.View entering={FadeIn} className="w-full flex-1 flex-col">
          <View className="flex-col sm:flex-row justify-between sm:items-end mb-4 gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm z-10">
            <View className="flex-1">
              <Text className="text-2xl font-black text-slate-900 tracking-tight">
                Schedule & Timetable
              </Text>
              <Text className="text-slate-600 text-sm mt-1 font-medium leading-relaxed">
                Your synchronized class sessions. Manage attendance and exam
                security modes here.
              </Text>
            </View>
            <Pressable
            ...
            >
              {DAYS.map((day) => (
                <Pressable
                  ...
                  className={`px-4 py-2.5 rounded-lg border transition-colors shadow-sm ${activeDay === day ? "bg-teal-600 border-teal-600" : "bg-white border-slate-200 hover:bg-slate-50"}`}
                >
                  <Text
                    className={`text-sm font-bold ${activeDay === day ? "text-white" : "text-slate-600"}`}
                  >
                    {day}
                  </Text>
                </Pressable>
          ...
          <ScrollView
            ...
            className="flex-1 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm"
          >
            <View className="pl-6 sm:pl-10 border-l-[3px] border-slate-100 relative pt-4 pb-12 w-full">
              ...
              >
                ...
                <View className="bg-teal-50 border-2 border-teal-200 p-5 rounded-2xl shadow-sm shadow-teal-500/10 group hover:border-teal-300 transition-colors">
                  ...
                  <Pressable
                    ...
                    className="bg-teal-600 hover:bg-teal-500 py-3 rounded-xl items-center active:bg-teal-700 active:scale-95 flex-row justify-center gap-2 shadow-lg shadow-teal-500/30 transition-all"
                  >
                    <MaterialCommunityIcons
              ...
              >
                ...
                <View className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm hover:border-slate-300 transition-colors">
                  <View className="flex-row items-center justify-between mb-2">
                    <Text className="text-xl font-black text-slate-900 tracking-tight">
                  ...
                  <View className="bg-slate-50 border border-slate-200 p-3 rounded-xl mb-4 shadow-sm flex-row justify-between items-center">
                    <View className="flex-row items-center gap-3">
                      ...
                      <View>
                        <Text className="text-slate-800 font-bold text-sm">
                          Upcoming Topic: Literary Analysis
                        </Text>
                        <Text className="text-slate-500 text-xs">
                          Awaiting lesson plan generation.
                        </Text>
                      </View>
                    </View>
                    <MaterialCommunityIcons
                  ...
                  <Pressable
                    ...
                    className="bg-white border border-slate-200 hover:bg-slate-50 mb-4 py-3 rounded-lg items-center active:bg-slate-100 active:scale-95 flex-row justify-center gap-2 shadow-sm transition-all"
                  >
                    <MaterialCommunityIcons
              ...
              <Animated.View
                ...
                className="relative opacity-70 mb-4"
              >
