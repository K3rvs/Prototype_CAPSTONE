            ...
            >
              <View className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm items-center">
                ...
                <Text className="text-slate-500 font-medium text-sm mb-3">
                  m.velasquez@deped.gov.ph
                </Text>

                <View className="bg-teal-50 px-3 py-1.5 rounded-full border border-teal-200">
                  <Text className="text-teal-800 text-[10px] font-black uppercase tracking-widest">
                    Subject Teacher
                  </Text>
                </View>
              </View>
                ...
                <View className="gap-4 mb-6">
                  <View className="flex-col sm:flex-row gap-4">
                    <View className="flex-1">
                      ...
                      <TextInput
                        defaultValue="Milio"
                        className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-teal-500 focus:bg-white transition-colors shadow-sm"
                      />
                    </View>
                    <View className="flex-1">
                      <Text className="text-slate-700 font-bold mb-2 text-sm">
                  ...
                  <View>
                    ...
                    <TextInput
                      defaultValue="m.velasquez@deped.gov.ph"
                      className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 outline-none text-slate-800 text-sm focus:border-teal-500 focus:bg-white transition-colors shadow-sm"
                    />
                  </View>
                </View>
