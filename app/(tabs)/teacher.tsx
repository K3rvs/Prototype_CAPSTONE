        ...
        <View className="gap-2">
          {GLOBAL_TABS.map((tab) => (
            <Pressable
              ...
              className={`flex-row items-center rounded-xl p-2.5 gap-3 ${!selectedClass && activeTab === tab.id ? "bg-teal-50 border border-teal-200/50 shadow-sm" : "border border-transparent hover:bg-slate-50"}`}
            >
              <MaterialCommunityIcons
                name={tab.icon as any}
                size={20}
                color={
                  !selectedClass && activeTab === tab.id ? "#0f766e" : "#64748b"
                }
              />
              <Text
                className={`font-bold text-sm ${!selectedClass && activeTab === tab.id ? "text-teal-900" : "text-slate-600"}`}
              >
                {tab.label}
              </Text>
            </Pressable>
    ...
    <SafeAreaView className="flex-1 bg-slate-50 relative overflow-hidden flex-row">
      ...
      <View className="flex-1 relative z-10">
        ...
        >
          ...
          >
            <View
              className={`w-full flex-1 ${selectedClass ? "hidden" : "flex"}`}
            >
              {activeTab === "workspace" && (
                <View
                  style={
              ...
              {activeTab === "remediation" && (
                ...
                >
                  <TeacherRemediationHub classes={classes} />
                </View>
              )}
              {activeTab === "faq" && (
                <View
            ...
            {selectedClass && (
              <View
                className="flex-1 flex-col h-full w-full relative bg-slate-50/50"
                style={
                  Platform.OS === "web"
                    ? ({
                        position: "fixed",
              ...
              >
                ...
                {activeTab === "announcements" && (
                  <View
                    className={`bg-${selectedClass.color || "teal"}-600 p-5 sm:p-6 flex-row items-center justify-between shadow-inner relative overflow-hidden group shrink-0 rounded-2xl`}
                  >
                    <MaterialCommunityIcons
                    ...
                    <View className="flex-1 pr-4 z-10">
                      ...
                      <View className="flex-row items-center gap-3 flex-wrap">
                        <View
                          className={`bg-${selectedClass.color || "teal"}-700/50 px-3 py-1 rounded border border-${selectedClass.color || "teal"}-500`}
                        >
                        ...
                        <Text
                          className={`text-${selectedClass.color || "teal"}-100 font-medium text-sm`}
                        >
                  ...
                  {Platform.OS === "web" && (
                    <View className="hidden xl:flex w-48 flex-col gap-2 shrink-0">
                      ...
                      {CLASS_TABS.map((t) => (
                        ...
                        >
                          <View
                            className={`w-7 h-7 bg-teal-50 rounded-lg items-center justify-center border border-teal-100`}
                          >
                            <MaterialCommunityIcons
                              name={t.icon as any}
                              size={16}
                          ...
                          <Text
                            className={`font-bold text-xs sm:text-sm flex-1 ${activeTab === t.id ? `text-teal-800` : "text-slate-700"}`}
                          >
                            {t.label}
                          </Text>
                        </Pressable>
                      ...
                      <View className="w-full shrink-0 p-4 pb-2">
                        ...
                        >
                          {CLASS_TABS.map((t) => (
                            ...
                            >
                              <View
                                className={`w-10 h-10 bg-teal-50 rounded-xl items-center justify-center border border-teal-100`}
                              >
                                <MaterialCommunityIcons
                                  name={t.icon as any}
                                  size={22}
                              ...
                              <Text
                                className={`font-bold text-xs text-center ${activeTab === t.id ? `text-teal-800` : "text-slate-700"}`}
                              >
                                {t.label}
                              </Text>
                            </Pressable>
                    ...
                    {activeTab === "classroom_ai" ? (
                      ...
                      >
                        ...
                        {activeTab === "materials" && (
                          ...
                          >
                            <TeacherClassMaterials classId={selectedClass.id} />
                          </View>
                        )}
                        ...
                        {activeTab === "directory" && (
                          ...
                          >
                            <TeacherClassDirectory classId={selectedClass.id} />
                          </View>
                        )}
                      </Animated.ScrollView>
                    )}
                  ...
                  >
                    {CLASS_TABS.map((t) => (
                      ...
                      >
                        ...
                        />
                        <Text
                          className={`text-[10px] font-bold text-center ${activeTab === t.id ? `text-teal-700` : "text-slate-500"}`}
                          numberOfLines={1}
                        >
                          {t.label}
                        </Text>
                    ...
                    return (
                      ...
                      >
                        ...
                        <View className="flex-1 justify-center">
                          ...
                          <Text
                            className={`text-[10px] font-bold uppercase tracking-wider ${notif.read ? "text-slate-400" : "text-teal-600"}`}
                          >
                            {notif.time}
                          </Text>
                        </View>
