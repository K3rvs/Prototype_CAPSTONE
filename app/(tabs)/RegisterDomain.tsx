      ...
      >
        ...
        >
          <View className="w-full max-w-xl mx-auto">
            ...
            <View className="mb-8">
              <View className="bg-purple-100 self-start px-4 py-1.5 rounded-full mb-4 border border-purple-200">
                <Text className="text-purple-800 font-bold text-[10px] uppercase tracking-widest">
                  Admin Configuration
                </Text>
              </View>
              ...
              <Text className="text-slate-600 text-base font-medium">
                Provision a new secure workspace for your institution.
              </Text>
            </View>
              ...
              <View className="flex-col sm:flex-row gap-5">
                <View className="flex-1">
                  ...
                  <TextInput
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3.5 text-base text-slate-800 outline-none focus:border-purple-500 transition-colors"
                  />
                </View>
                <View className="flex-1">
                  <Text className="font-bold text-slate-700 mb-2 text-sm">
            ...
            <Pressable
              ...
              className="w-full h-14 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 rounded-2xl items-center justify-center shadow-md shadow-purple-500/30 transition-transform active:scale-[0.98]"
            >
              <Text className="text-white font-black text-lg">
                Proceed to Admin Profile
              </Text>
            </Pressable>
          </View>
        </ScrollView>
